...
- Measures of Central Tendency: Mean, Geometric mean, Median, Mode*.
...
* Mode: Returns a single value or NO if it does not exist. If there is more than one, return one of them and indicate that there is more.
